...
class TestTag(unittest.TestCase):
    ...
    def test_subtags_correct_type(self):
        ...
        # Test 4-character numeric variant (e.g., 1901 for German traditional orthography)
        tag = Tag("de-1901")
        subtags = tag.subtags
        self.assertEqual(len(subtags), 2)
        self.assertEqual(subtags[0].type, "language")
        self.assertEqual(subtags[0].format, "de")
        self.assertEqual(subtags[1].type, "variant")
        self.assertEqual(subtags[1].format, "1901")
    ...
    def test_errors_deprecated_grandfathered(self):
        ...
        self.assertEqual(
            err.message, "The tag art-lojban is deprecated. Use 'jbo' instead."
        )
    ...
    def test_errors_multiple_script_subtags(self):
        ...
        self.assertEqual(
            err.message,
            "The script subtag 'Latn' is the same as the language suppress-script.",
        )
        err = errs[1]
        self.assertEqual(err.code, tag.ERR_EXTRA_SCRIPT)
    ...
    def test_errors_wrong_order_subtags(self):
        ...
        self.assertEqual(
            err.message, "The subtag 'MT' should not appear before 'Arab'."
        )
    ...
    def test_description(self):
        ...
        self.assertEqual(
            tag.descriptions, ["English, Oxford English Dictionary spelling"]
        )
    ...
    def test_format(self):
        ...
        self.assertEqual(
            Tag("en-x-more-than-eight-chars").format, "en-x-more-than-eight-chars"
        )
        self.assertEqual(Tag("En").format, "en")
        self.assertEqual(Tag("EN").format, "en")
        self.assertEqual(Tag("eN").format, "en")
